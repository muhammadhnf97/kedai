...
const Verification = ({ desc, alertTitle, handleClickResponseNotif }) => {
    let answer
    if(alertTitle === 'info'){
  ...
  return (
    <div className='fixed w-full h-full bg-black flex items-center justify-center top-0 bg-opacity-80 z-30 p-5'>
