  ...
  return (
    <form onSubmit={(e)=>handleSubmit(e)}>
        ...
        <div className='w-full space-y-2 mt-5 md:flex md:space-y-0 md:justify-between md:gap-10'>
            <button type='submit' className='w-full bg-green-400 py-2 hover:bg-green-500 active:bg-green-600'> Simpan </button>
            <button type='button' className='w-full bg-red-400 py-2 hover:bg-red-500 active:bg-red-600' onClick={handleClickReset}> Bersihkan </button>
        </div>
    </form>
  )
}
